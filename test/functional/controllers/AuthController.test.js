        ...
        [
            {
                payload: null || '' || {},
                status: 401,
                condition: 'null or empty string or empty object as login payload...'
            },
            // {
            //     payload: '',
            //     status: 401,
            ...
            // },
            {
                ...
                status: 401,
                condition: 'empty string identifier or dummy string "foo" indetifier or empty string password or dummy string "bar" password as login payload'
            },
            // {
            //     payload: {
            //         identifier: 'foo',
